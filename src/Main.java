...
public class Main {
    public static void main(String[] args) {
        ...
        String tipoUsuario1 = (args.length >= 1) ? args[0] : "Admin";
        String tipoUsuario2 = (args.length >= 2) ? args[1] : "Usuario";
        ...
        Usuario U2 = Usuario.builder()
                ...
                .fechaNacimiento(LocalDate.of(2000, 8, 6))
                .build();
        Usuario U3 = Usuario.builder()
                .nombre("Lucia")
                .email("lucy@gmail.com")
                .direccion("Los alpes 123")
                .fechaNacimiento(LocalDate.of(2004, 4, 14))
                .build();
